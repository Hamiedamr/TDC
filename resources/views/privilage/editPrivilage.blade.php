...
@section('title')
{{trans('data.editprivilage')}}
@append
      
  @push('styles')
  <link rel="stylesheet" href="{{ asset('custom/css/privilage/editPrivilage.css')}}">
  @endpush

   
  @push('scripts')
  <script src="{{ asset('custom/js/privilage/editPrivilage.js')}}"></script>
   @endpush
 ...
 <form class="form-horizontal"  name="privilages_add_form" action="#" method="post">
  ...
  <div class="container form">
        <!--Heading-->
     <div class="heading">
        <u><h2>{{trans('data.editprivilage')}}</h2></u>
        </div>
