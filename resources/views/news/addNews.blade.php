...
@append
  ...
  @push('styles')
  <link rel="stylesheet" href="{{ asset('custom/css/news/addNews.css')}}">
  @endpush

   
  @push('scripts')
  <script src="{{ asset('custom/js/news/addNews.js')}}"></script>
   @endpush
   ...
   <!--Form UI-->
 <form class="form-horizontal"  name="news_add_form" action="#" method="post">
  {{csrf_field()}}
  <div class="container form">
        <!--Heading-->
     <div class="heading">
        <u><h2>{{trans('data.addnews')}}</h2></u>
        </div>
