...
@section('title')
    {{trans('data.addCollege')}}
@append


@push('styles')
    <link rel="stylesheet" href="{{ asset('custom/css/college/collegeAdd.css')}}">
@endpush

@push('scripts')
    <script src="{{ asset('custom/js/college/collegeAdd.js')}}"></script>
@endpush
...
@section('content')
    <!--Form UI-->
    <form class="form-horizontal" name="college_add_form" action="{{ route('college.store') }}" method="POST">
        {{csrf_field()}}
        <div class="container form">
            <!--Heading-->
            <div class="heading">
                <u><h2>{{ trans ('data.addCollege')}}</h2></u>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" required="required" minlength="3" maxlength="255"
                           name="nameA" id="college_ar" placeholder="{{ trans ('data.arnameholder')}}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" required="required" minlength="3" maxlength="255"
                           name="nameE" id="college_en" placeholder="{{ trans ('data.ennameholder')}}">
                    <span class="form_hint">{{trans('data.minmax')}}</span>
                    <span class="star">*</span>
            ...
            <div class="form-group dropdown">
                ...
                <div class="col-md-6 col-md-push-2">
                    <select id="university" name="university_id" required="required">
                        <option value="" disabled="disabled" selected>----- {{trans('data.selectUniversity')}}------
                        </option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-md-push-2" style="margin-left:20px">
                    <label><input id="radio_button" type="radio" name="type" value="theoretical"
                                  required>{{trans('data.theoritical')}}</label>
                    <label><input id="radio_button" type="radio" name="type"
                                  value="practical">{{trans('data.practical')}}</label>
