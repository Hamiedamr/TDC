...
@section('content')
    ...
    {{ Form::open(['url' => route('course.update',$course['id']),'method'=>'PUT','name'=>'trainer_signup_form','class'=>'form-horizontal','id'=>'course_add_form','files'=>true]) }}

    <div class="container form">
        <!--Heading-->
        <div class="heading">
            <u><h2>{{trans('data.editCourse')}}</h2></u>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                {{ Form::text('codeA', $course->codeA, array('class' => 'form-control','required'=>true,'id'=>'code_ar',
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                {{ Form::text('codeE', $course->codeE, array('class' => 'form-control','required'=>true,'id'=>'code_en',
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                {{ Form::text('nameA', $course->nameA, array('class' => 'form-control','required'=>true,'id'=>'name_ar',
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                {{ Form::text('nameE', $course->nameE, array('class' => 'form-control','required'=>true,'id'=>'name_en',
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-md-push-2" style="margin-left:20px">
                <label><input id="radio_button" type="radio" name="programType" value="promotion"
                              required @if($course->programType == 'promotion') checked @endif> {{trans('data.promotion')}}</label>
                <label><input id="radio_button" type="radio" name="programType"
                              value="external" @if($course->programType == 'external') checked @endif> {{trans('data.external')}}</label>
            ...
            <div class="col-md-6 col-md-push-2">
                <select id="main_program" name="program_id" required="required">
                    ...
                    @foreach ($types as $category)
                        <option value="{{ $category['id'] }}" @if($course->program_id == $category->id) selected @endif>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                {{ Form::number('totalHours', $course->totalHours, array('class' => 'form-control','id'=>'course_hr',
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                {{ Form::number('countToOpen', $course->countToOpen, array('class' => 'form-control','id'=>'arid',
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                {{ Form::number('freeCount', $course->freeCount, array('class' => 'form-control','id'=>'arid',
        ...
        <div class="form-group">
            ...
            <div class="col-md-8 col-md-push-2" style="margin-left:20px">
                <input id="check_box" type="checkbox" name="mandatory" value="0"  hidden>
                <input id="check_box" type="checkbox" name="mandatory" value="1" @if($course->mandatory == '1') checked @endif>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8 col-md-push-2" style="margin-left:20px">
                <label><input id="radio_button" type="radio" name="type" value="practical"
                              required @if($course->type == 'practical') checked @endif> {{trans('data.practical')}}</label>
                <label><input id="radio_button" type="radio" name="type"
                              value="theoretical" @if($course->type == 'theoretical') checked @endif> {{trans('data.theoritical')}}</label>
